...
public class FeatureFormatter {
	static final Logger logger = Logger.getLogger(FeatureFormatter.class
			.getName());

	public static void main(String[] args) throws Exception {

		formatCRFMallet(args[0]);
		// formatCRFMallet("./data/yahoonews-10fold-tagged");
	}

	public static void formatCRFMallet(String dataDir) throws Exception {
		...
		final List<String> featureNames = Arrays.asList(new Feature[] { //
						...
						new A_P_KeyWord(), // new Average Probability of Supporting Document Keywords
						new P_KeyWord(), // new Probability of Supporting Document Keywords
						new R_P_KeyWord(), // new Relative Probability of Supporting Document Keywords
						new STF_IDF(), // new Social TF-IDF*/
						new LabelFeature(), // for class
